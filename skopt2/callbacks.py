...
class CheckpointSaver(object):
    """
    Save current state after each iteration with :class:`skopt2.dump`.
    ...
    >>> def obj_fun(x):
    ...     return x[0]**2
    >>> checkpoint_callback = skopt2.callbacks.CheckpointSaver("./result.pkl")
    >>> skopt2.gp_minimize(obj_fun, [(-2, 2)], n_calls=10,
    ...
    dump_options : string
        options to pass on to `skopt2.dump`, like `compress=9`
    """
