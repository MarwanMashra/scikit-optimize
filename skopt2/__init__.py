"""
Scikit-Optimize, or `skopt2`, is a simple and efficient library to
minimize (very) expensive and noisy black-box functions. It implements
several methods for sequential model-based optimization. `skopt2` is reusable
...
if __SKOPT2_SETUP__:
    ...
    sys.stderr.write("Partial import of skopt2 during the build process.\n")
